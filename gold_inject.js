const mainDivName = document.querySelector("body").children[2].children[0].children[0].children[0].children[0].children[0].children[0].children[0].id;
...
function addMoney() {
    ...
    stateNode.setState({
        gold: stateNode.state.gold + amountWanted,
        gold2: stateNode.state.gold + amountWanted
    });
}
...
function giveGold() {
    ...
    let { stateNode } = Object.values(document.querySelector(stateNodeSelector))[1].children[0]._owner; stateNode.props.liveGameController.setVal({ path: "c/".concat(stateNode.props.client.name), val: { b: stateNode.props.client.blook, cr: stateNode.state.gold, tat: `${playerToGiveTo}:-${amountGive}` } });
}
...
function stealGold() {
    ...
    let { stateNode } = Object.values(document.querySelector(stateNodeSelector))[1].children[0]._owner; stateNode.props.liveGameController.setVal({ path: "c/".concat(stateNode.props.client.name), val: { b: stateNode.props.client.blook, cr: stateNode.state.gold, tat: `${playerToSteal}:${amountSteal}` } });
    stateNode.setState({
        gold: stateNode.state.gold + amountSteal,
        gold2: stateNode.state.gold + amountSteal
    });
}
